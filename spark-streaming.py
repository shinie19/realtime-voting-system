...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
            ...
            .config("spark.jars", "/home/anhnn/Workspace/AnhNN/realtime_voting_sys/postgresql-42.7.1.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/anhnn/Workspace/AnhNN/realtime_voting_sys/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/home/anhnn/Workspace/AnhNN/realtime_voting_sys/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
    ...
    #     .option("checkpointLocation", "/home/anhnn/Workspace/AnhNN/realtime_voting_sys/checkpoints/checkpoint4") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "/home/anhnn/Workspace/AnhNN/realtime_voting_sys/checkpoints/checkpoint3") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "/home/anhnn/Workspace/AnhNN/realtime_voting_sys/checkpoints/checkpoint6") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "/home/anhnn/Workspace/AnhNN/realtime_voting_sys/checkpoints/checkpoint7") \
    #     .outputMode("update") \
    #     .start()
